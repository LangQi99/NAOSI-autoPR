...
def build_pr_comment_prompt(
    ...
    return (
        ...
        "- In those cases, split the page into clearer topic pages instead of continuing to append everything to one place. For example, a page like \"选课指南\" may deserve separate pages for \"选课系统\" and \"选课思路\" once the content grows in different directions.\n"
